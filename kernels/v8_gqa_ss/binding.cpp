// pybind glue for the v8.7 score-stationary GQA M-packing decode kernel. The heavy lifting
// (score-stationary partial with FP16 transposed smem + LSE merge) lives in gqa_ss_attention.cu; this
...
// Declared here, defined in gqa_ss_attention.cu (compiled together by cpp_extension.load).
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("forward", &gqa_ss_attention_forward,
          "v8.7 score-stationary GQA M-packing paged split-KV decode forward, FP16 transposed smem "

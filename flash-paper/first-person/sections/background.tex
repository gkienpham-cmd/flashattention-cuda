...
B200 GEMMs where a microbenchmark-grounded model reaches 1.31\% MAE. My
...
My headline architecture is the B300 (GB300, \texttt{sm\_103}). I use
...
peaks of 2.5\,PF (FP16), 5\,PF (FP8), and 15\,PF (block-scaled NVFP4). I also
measured the exponential throughput used by softmax: an EX2 microkernel sustains
\textbf{5.33\,TExp/s}, only $0.50\times$ the 10.7\,TExp/s vendor peak. I fold

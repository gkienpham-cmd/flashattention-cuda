...
\textbf{5.33\,TExp/s}, only $0.50\times$ the 10.7\,TExp/s vendor peak---a datasheet
gap we fold into the model but which is immaterial to $M{=}1$ decode (the MUFU
term is $<3\%$ of decode time).

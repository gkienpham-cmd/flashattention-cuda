...
\begin{figure}[t]
  \centering
  \includesvg[width=\columnwidth]{v1-v12-arc-summary}
  \caption{The v1--v12 arc as four phases: prefill \emph{schedule}
  (v1--v5), decode \emph{shape} (v6--v8, v11), \emph{precision}
  (v9--v10), and \emph{engine} (v12). Each arrow changes a single variable.}
  \label{fig:arc}
\end{figure}
...
A100 (\texttt{sm\_80}), B200 (\texttt{sm\_100}), and B300 (\texttt{sm\_103}).
